...
public class XWebChromeClient extends WebChromeClient {
    ...
    public boolean onShowFileChooser(WebView webView,
        ...
        * */
        ...
        mActivity.startActivityForResult(intent, XWebView.WEB_REQ_CODE);
    ...
    public void onProgressChanged(WebView view, int newProgress) {
        ...
        if (newProgress == 100) {
            ...
            if (mMyWebView.mProgressBar.getVisibility() == View.GONE) {
                mMyWebView.mProgressBar.setVisibility(View.VISIBLE);
            }
            mMyWebView.mProgressBar.setProgress(newProgress);
        }
    }
